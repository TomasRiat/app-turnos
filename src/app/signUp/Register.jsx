            ...
            <form onSubmit={handleForm} className="flex flex-col gap-4 justify-center items-center w-[270px] ">
                <div className="flex flex-row justify-center items-center gap-4">
                    <label htmlFor="email" className="flex flex-col gap-2 w-full">
                        <p>Nombre</p>
                        <input onChange={(e) => setEmail(e.target.value)} required type="name" name="name" id="name" placeholder="Juan" className="w-[127px] bg-transparent border-2 border-marron rounded-2xl p-2 outline-none"/>
                    </label>
                    <label htmlFor="email" className="flex flex-col gap-2 w-full">
                        <p>Apellido</p>
                        <input onChange={(e) => setEmail(e.target.value)} required type="lastname" name="lastname" id="lastname" placeholder="Perez" className="w-[127px] bg-transparent border-2 border-marron rounded-2xl p-2 outline-none"/>
                    </label>
                </div>
                <label htmlFor="email" className="flex flex-col gap-2 w-full">
                    <p>Email</p>
